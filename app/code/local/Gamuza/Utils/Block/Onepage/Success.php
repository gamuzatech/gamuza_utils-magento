 ...
 * These files are distributed with gamuza_utils-magento at http://github.com/gamuzabrasil/.
 */

class Gamuza_Utils_Block_Onepage_Success
...
{
    return true; // to view orders as a guest.
}
